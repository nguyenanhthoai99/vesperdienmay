...
$kq  = $_GET['sp'];
$query = oneRaw("SELECT * FROM sanpham as sp INNER JOIN maygiat as mg ON mg.id_sp = sp.id_sp INNER JOIN nhasanxuat as nsx ON nsx.id_nsx = mg.id_nsx WHERE sp.ten_sp = '$kq'");
$id = $query['id_sp'];
$lsp = $query['id_lsp'];
