...
adminLogin();
$data = ['pageTitle' => 'Quản lý sản phẩm tủ đông'];
layouts('header-admin', $data);
$filterAll = filter();
$page = !empty($filterAll['page']) ? $filterAll['page'] : 1;
$itemPage = 10;
$offset = ($page - 1) * $itemPage;
$queryMatGiat = getRaw("SELECT * FROM sanpham as sp INNER JOIN thuonghieu as th ON th.id_th = sp.id_th WHERE id_lsp = 3 ORDER BY update_at DESC, create_at DESC LIMIT " . $itemPage . " OFFSET " . $offset);
    ...
    <div class="container-fulid">
        ...
        <div class="row" style="margin: 0px 0px 15px 0px">
            ...
            <div class="col-9 content">
                <h2 class="text-center title-login">QUẢN LÝ SẢN PHẨM TỦ ĐÔNG</h2>
                <?php
                    ...
                    <tbody>
                        <?php foreach ($queryMatGiat as $item) : ?>
                            <tr>
                                ...
                                <td><img src="<?php echo _WEB_HOST_TEMPLATES ?>/images/tudong/<?php echo $item['hinhanh'] ?>" id="anhDemo" name="anhDemo" width="150px" height="150px" class="rounded mx-auto d-block"></td>
