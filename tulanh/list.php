...
adminLogin();
$data = ['pageTitle' => 'Quản lý sản phẩm tủ lạnh'];
layouts('header-admin', $data);
$filterAll = filter();
$page = !empty($filterAll['page']) ? $filterAll['page'] : 1;
$itemPage = 10;
$offset = ($page - 1) * $itemPage;
$queryTuLanh = getRaw("SELECT * FROM sanpham as sp INNER JOIN thuonghieu as th ON th.id_th = sp.id_th WHERE id_lsp = 6 ORDER BY update_at DESC, create_at DESC LIMIT " . $itemPage . " OFFSET " . $offset);
$tongTuLanh = getRows("SELECT * FROM sanpham WHERE id_lsp = 6");
$tongPage = ceil($tongTuLanh / $itemPage);
$stt = $offset + 1;
    ...
    <div class="container-fulid">
        ...
        <div class="row" style="margin: 0px 0px 15px 0px">
            ...
            <div class="col-9 content">
                <h2 class="text-center title-login">QUẢN LÝ SẢN PHẨM TỦ LẠNH</h2>
                <?php
                ...
                <table class="table table-bordered align-middle text-center table-list mt-3 border-secondary">
                    ...
                    <tbody>
                        <?php foreach ($queryTuLanh as $item) : ?>
                            <tr>
                                ...
                                <td><img src="<?php echo _WEB_HOST_TEMPLATES ?>/images/tulanh/<?php echo $item['hinhanh'] ?>" id="anhDemo" name="anhDemo" width="150px" height="150px" class="rounded mx-auto d-block"></td>
