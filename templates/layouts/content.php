    ...
    <div class="row" style="margin: 0px">
        ...
        <div class="col-8 content">
            ...
            <div class="main-content">
                ...
                <div class="row">
                    <a href="" class="col-3 main-item card" title="test">
                        <img src="<?php echo _WEB_HOST_TEMPLATES; ?>/images/maygiat/may-giat-samsung-inverter-9-kg-w.jpg" class="card-img-top img-item" alt="..." onmouseenter="increaseSize(this)" onmouseout="decreaseSize(this)">
                        <div class="card-body">
                            <p class="card-title ten-item">Tên máy giặt</p>
                            <p class="card-text gia-item">100000<span class="dong-item">&#8363;</span></p>
                            <p class="card-text giacu-item">100000<span class="dong-item">&#8363;</span></p> 
                            <p class="card-text qua-item">Quà</p>
                        </div>
                    </a>
                    <a href="" class="col-3 main-item card" title="test">
                        <img src="<?php echo _WEB_HOST_TEMPLATES; ?>/images/maygiat/may-giat-samsung-inverter-9-kg-w.jpg" class="card-img-top img-item" alt="..." onmouseenter="increaseSize(this)" onmouseout="decreaseSize(this)">
