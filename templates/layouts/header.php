        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse menu-header" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-primary" aria-current="page" href="#">Giới thiệu</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-primary" aria-current="page" href="#">Liên hệ</a>
                    </li>
                    <form class="d-flex" role="search" method="get">
                        <input class="form-control me-2" type="search" placeholder="Nhập sản phẩm bạn muốn tìm kiếm" aria-label="search" style="width : 500px">
