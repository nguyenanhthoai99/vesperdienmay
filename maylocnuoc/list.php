...
adminLogin();
$data = ['pageTitle' => 'Quản lý sản phẩm máy nước lọc'];
layouts('header-admin', $data);
$filterAll = filter();
$page = !empty($filterAll['page']) ? $filterAll['page'] : 1;
$itemPage = 10;
$offset = ($page - 1) * $itemPage;
$queryMayNuocLoc = getRaw("SELECT * FROM sanpham as sp INNER JOIN thuonghieu as th ON th.id_th = sp.id_th WHERE id_lsp = 2 ORDER BY update_at DESC, create_at DESC LIMIT " . $itemPage . " OFFSET " . $offset);
$tongMayNuocLoc = getRows("SELECT * FROM sanpham WHERE id_lsp = 2");
$tongPage = ceil($tongMayNuocLoc / $itemPage);
$stt = $offset + 1;
    ...
    <div class="container-fulid">
        ...
        <div class="row" style="margin: 0px 0px 15px 0px">
            ...
            <div class="col-9 content">
                <h2 class="text-center title-login">QUẢN LÝ SẢN PHẨM MÁY LỌC NƯỚC</h2>
                <?php
                ...
                <table class="table table-bordered align-middle text-center table-list mt-3 border-secondary">
                    ...
                    <tbody>
                        <?php foreach ($queryMayNuocLoc as $item) : ?>
                            <tr>
                                ...
                                <td><img src="<?php echo _WEB_HOST_TEMPLATES ?>/images/maylocnuoc/<?php echo $item['hinhanh'] ?>" id="anhDemo" name="anhDemo" width="150px" height="150px" class="rounded mx-auto d-block"></td>
