...
adminLogin();
$data = ['pageTitle' => 'Thêm thông tin máy lọc nước'];
...
if (isPost()) {
    ...
    if (empty($errors)) {
        ...
        if ($inserStatusSP) {
            ...
            $inserStatusMayLocNuoc = insert('maylocnuoc', $dataInsertMayLocNuoc);
            if (!empty($inserStatusMayLocNuoc)) {
                setFlashData('msg', 'Thêm mới máy lọc nước thành công!');
                setFlashData('msgType', 'success');
                redirect(_WEB_HOST . '/maylocnuoc/list.php');
            }
        } else {
            setFlashData('msg', 'Thêm mới máy lọc nước không thành công!');
...
<div class="container-fulid">
    ...
    <div class="row" style="margin: 0px">
        ...
        <div class="col-7 content">
            <div class="col">
                <h2 class="text-center title-login">THÊM SẢN PHẨM MỚI MÁY LỌC NƯỚC</h2>
                <?php
