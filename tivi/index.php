...
<div class="container" style="margin-top: 100px">
    <div class="row main-lsp" style="margin:0px">
        ...
        $queryTivi = getRaw("SELECT * FROM sanpham WHERE id_lsp = 5 ORDER BY update_at DESC, create_at DESC LIMIT " . $itemPage . " OFFSET " . $offset);
        $tongTivi = getRows("SELECT * FROM sanpham WHERE id_lsp = 5");
        $tongPage = ceil($tongTivi / $itemPage);
